	      ...
	      <div class="modal-body">
	        ...
	        <form name="" method="post" id="editUserForm" class="form-horizontal">
	          <div class="form-group">
	           ...
	           <div class="form-group">
	            <label for="recipient-age" class="col-sm-2 control-label">所属机构:</label>
	            <div class="col-sm-10">
	            	<input type="text" name="hid" class="form-control" id="recipient-age">
	            </div>
	          </div>
	          <div class="form-group">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		    ...
		    <div class="table-container">
		    	<table class="table table-hover">
		    		...
		    		<tbody>
		    			<c:forEach items="${packageList}" var="hos">
		    				<tr>
			    				<td>
...
<%@ include file="../common/footer.jsp" %>
	...
	<script src="dist/js/admin/package-handler.js"></script>
