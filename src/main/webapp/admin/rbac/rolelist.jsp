	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <form name="" method="post" id="editUserForm" class="form-horizontal">
	          ...
	          <div class="form-group">
	            <label for="recipient-age" class="col-sm-2 control-label">是否开启:</label>
	            <div class="col-sm-10">
	            	<label>
	            		<input type="radio" name="isOpen" id="recipient-age" value="1">
	            		开启
	            	</label>
	            	<label>
	            		<input type="radio" name="isOpen" id="recipient-age" value="0">
	            		关闭
	            	</label>
	            </div>
	          </div>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		    ...
		    <div class="table-container">
		    	<table class="table table-hover">
		    		...
		    		<tbody>
		    			<c:forEach items="${roleList}" var="hos">
		    				<tr>
			    				<td>
			    				...
			    				<td>
			    					<button type="button" class="btn btn-default" data-toggle="modal" data-target="#ifHandle" data-whatever="${hos.id}-edit">编辑 </button>
			    					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ifHandle" data-whatever="${hos.id}-assign">分配权限 </button>
...
<%@ include file="../common/footer.jsp" %>
	...
	<script src="dist/js/admin/role-handler.js"></script>
