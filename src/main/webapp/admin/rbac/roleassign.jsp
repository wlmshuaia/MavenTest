	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		    ...
		    <div class="table-container">
		    	...
		    	<c:forEach items="${mapList}" var="oneMap">
		    		...
		    		<c:forEach items="${oneMap.keySet()}" var="one">
		    			<div class="panel panel-default">
						  ...
						  <div class="panel-body">
						  	...
						  	<c:forEach items="${oneMap.get(one).get('child')}" var="twoMap">
			    				<c:forEach items="${twoMap.keySet()}" var="two">
			    					...
			    					<div class="panel panel-default">
									  ...
									  <c:if test="${!empty twoMap[two]['child']}">
									  	<div class="panel-body">
									  		<ul class="list-group ul-inline">
			  			    					<c:forEach items="${twoMap.get(two).get('child')}" var="node">
